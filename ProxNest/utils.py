...
def create_parameters_dict(y=0, Phi=sense.Identity, Psi=sense.Identity, epsilon=1e-3, tight=True, nu=1, tol=1e-3, max_iter=200, verbose=1, u=0, pos=False, reality=False, l1weights=None, rel_obj=0):
...
def create_options_dict(samplesL = 1e3, samplesD = 1e4, thinning = 1e2, delta =1e-8, burn = 1e2, sigma = 1):
