...
def l1_norm_prox(x, lamb, params):
    ...
    if (params['tight']) and (params['pos'] or params['reality']):
        ...
        sol = x + 1/params['nu'] * params['Psi'].adj_op(ops.soft_thresh(temp, lamb*params['nu']*params['weights'])-temp)
    ...
    # NON TIGHT FRAME CASE OR CONSTRAINT INVOLVED
        ...
        while 1:
            ...
            # Log
            if params['verbose'] > 1:
                print('   Iter {}, prox_fval = {}, rel_fval = {}'.format(iter_L1, obj, rel_obj))
    ...
    if params['verbose'] >= 1:
        print('  prox_L1: prox_fval = {}, {}, iter = {}'.format(norm_l1, crit_L1, iter_L1))
